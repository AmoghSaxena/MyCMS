			...
			3683: function(e, t, n) {
				...
				var L = function(e) {
					...
					function u(e) {
						...
						o.PageStore.on("switched_media_auto_play", t.onUpdateMediaAutoPlay.bind(j(t))), t.browserCache = new p.BrowserCache(i.SiteContext._currentValue.id, 86400);
						var d = new p.MediaDurationInfo;
						return d.update(t.props.data.duration), t.durationISO8601 = d.ISO8601(), t.playerElem = null, t.playerInstance = null, t.onPlayerInit = t.onPlayerInit.bind(j(t)), t.onClickNext = t.onClickNext.bind(j(t)), t.onClickPrevious = t.onClickPrevious.bind(j(t)), t.onStateUpdate = t.onStateUpdate.bind(j(t)), t.onVideoEnd = t.onVideoEnd.bind(j(t)), t.onVideoRestart = t.onVideoRestart.bind(j(t)), t
					}
					return t = u, (n = [{
						key: "componentDidMount",
						value: function() {
				...
				L.defaultProps = {
					...
					if (r) return (n = videojs(r)).playsinline(!0), 1 == R("muted") && n.muted(!0), R("time") >= 0 && n.currentTime(R("time")), 1 == R("autoplay") && n.play(), void t.disconnect()
				})).observe(document, {
					childList: !0,
					subtree: !0
				}), n(9808);
				...
				function ne(e) {
					var t = (0, a.useRef)(null),
						...
						u = s[0],
						c = s[1],
						d = G((0, a.useState)(!1), 2),
						m = d[0],
						p = d[1],
						y = G((0, a.useState)(-1), 2),
						h = y[0],
						g = y[1],
						v = G((0, a.useState)(""), 2),
						b = v[0],
						S = v[1],
						w = G((0, a.useState)(i.MemberContext._currentValue.is.anonymous ? i.LinksContext._currentValue.signin + "?next=/" + window.location.href.replace(i.SiteContext._currentValue.url, "").replace(/^\//g, "") : null), 1)[0];
				...
				function ae(e) {
					var t, n = (0, a.useRef)(null),
						r = (0, a.useRef)(null),
						o = G((0, a.useState)(!0), 2),
						l = o[0],
						s = o[1],
						u = G((0, a.useState)(!1), 2),
						c = u[0];
				...
				function oe(e) {
					var t = G((0, a.useState)(o.MediaPageStore.get("media-id")), 2),
						n = t[0],
						r = (t[1], G((0, a.useState)(i.MemberContext._currentValue.can.readComment ? o.MediaPageStore.get("media-comments") : []), 2)),
						l = r[0],
						s = r[1],
						u = G((0, a.useState)(!1), 2),
						c = u[0],
					...
					function m() {
						...
						}(t), !0 === MediaCMS.features.media.actions.comment_mention && e.forEach((function(e) {
							e.text = e.text.split("@(_").join('<a href="/user/').split("_)[_").join('">').split("_]").join("</a>")
						})), t.one("loadedmetadata", (function() {
							e.forEach((function(e) {
									var n, r, a;
									e.text = (n = e.text, r = t, a = new RegExp("((\\d)?\\d:)?(\\d)?\\d:\\d\\d", "g"), n.replace(a, (function(e, t) {
										for (var a = e.split(":"), i = 0, l = 1, s = new URLSearchParams(window.location.search); a.length > 0;) i += l * parseInt(a.pop(), 10), l *= 60;
										return MediaCMS.features.media.actions.timestampTimebar && function(e, t, n) {
											e.markers.add([{
												time: t,
												text: n
											}])
										}(r, i, n), s.set("t", i), '<a href="' + o.MediaPageStore.get("media-url").split("?")[0] + "?" + s + '">' + e + "</a>"
									})))
								})),
								function() {
									...
									if ("" === n) t && 0 === comm.length && t.parentNode.removeChild(t);
										...
										if (-1 < i.LinksContext._currentValue.profile.media.indexOf(o.MediaPageStore.get("media-data").author_profile) && !t) {
											...
											r.setAttribute("role", "alert"), r.setAttribute("class", "alert info alert-dismissible no-comment"), r.innerHTML = '<button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">×</span></button>' + n, e.firstChild ? e.insertBefore(r, e.firstChild) : e.appendChild(r), r.querySelector("button.close").addEventListener("click", (function(e) {
												return r.setAttribute("class", "alert info alert-dismissible hiding"), setTimeout((function() {
													r.parentNode.removeChild(r)
												}), 400), e.preventDefault(), e.stopPropagation(), !1
											}))
										}
									} else t && 0 < comm.length && t.parentNode.removeChild(t)
								}(), s(Z(e))
						})), s(Z(e))
					}
				...
				function ye(e) {
					...
					s = s ? s.trim() : "";
					var u = se((0, B.usePopup)(), 3),
						c = u[0],
						d = u[1],
						p = u[2],
						y = se((0, a.useState)("" !== s), 2),
						h = y[0],
						g = (y[1], se((0, a.useState)("" == s), 2)),
						v = g[0],
						b = g[1];
					...
					function S(e) {
						...
						}), 100), void 0 !== e && le.info("Removed media '" + e + '"')
					}

					function w(e) {
						setTimeout((function() {
							f.PageActions.addNotification("Media removal failed", "mediaDeleteFail")
						}), 100), void 0 !== e && le.info('Media "' + e + '" removal failed')
				...
				function ve() {
					var e = he((0, a.useState)(o.MediaPageStore.get("user-disliked-media")), 2),
						t = e[0],
						n = e[1],
						r = he((0, a.useState)((0, m.formatViewsNumber)(o.MediaPageStore.get("media-dislikes"), !1)), 2),
						l = r[0],
						s = r[1];
				...
				function we() {
					var e = be((0, a.useState)(o.MediaPageStore.get("user-liked-media")), 2),
						t = e[0],
						n = e[1],
						r = be((0, a.useState)((0, m.formatViewsNumber)(o.MediaPageStore.get("media-likes"), !1)), 2),
						l = r[0],
						s = r[1];
				...
				function xe(e) {
					var t = (0, B.useUser)().userCan,
						...
						d = u[1],
						p = u[2],
						y = ke((0, a.useState)(!1), 2),
						h = y[0],
						g = y[1],
						v = ke((0, a.useState)(!1), 2),
						b = v[0],
						S = v[1],
						w = ke((0, a.useState)({}), 2),
						E = w[0],
						P = w[1],
						k = ke((0, a.useState)("main"), 2),
						_ = k[0],
						M = k[1],
						A = ke((0, a.useState)(Ce), 2),
						C = A[0],
						x = A[1];
					...
					return (0, a.useEffect)((function() {
						...
						var n = Ce;
						e.allowDownload && t.downloadMedia && "videoDownloadOptions" === _ && (n += " video-downloads"), 1 === Object.keys(E).length && e.allowDownload && t.downloadMedia && (s || r) && (n += " visible-only-in-small"), x(n)
				...
				function je(e) {
					var t = (0, a.useRef)(null),
						n = (0, a.useRef)(null),
						r = Oe((0, a.useState)(new Date), 2),
						i = r[0],
						l = r[1],
						s = Oe((0, a.useState)(o.MediaPageStore.get("playlists")), 2),
						u = s[0],
						c = s[1],
						d = Oe((0, a.useState)(!1), 2),
						m = d[0],
						p = d[1];
				...
				function Re(e) {
					var t, n = Ve((0, B.usePopup)(), 3),
						r = n[0],
						i = n[1],
						o = n[2],
						l = Ve((0, a.useState)("selectPlaylist"), 2),
						s = l[0],
						u = l[1];
					return a.createElement("div", {
						className: "save"
				...
				function Be(e) {
					var t = o.PageStore.get("config-options").embedded.video.dimensions,
						...
						u = (0, a.useRef)(null),
						c = (0, a.useRef)(null),
						d = De((0, a.useState)(window.innerHeight - 144 + 56), 2),
						m = d[0],
						p = d[1],
						y = De((0, a.useState)(!1), 2),
						h = y[0],
						g = y[1],
						v = De((0, a.useState)("16:9"), 2),
						b = v[0],
						S = v[1],
						w = De((0, a.useState)(t.width), 2),
						E = w[0],
						P = w[1],
						k = De((0, a.useState)(t.widthUnit), 2),
						_ = k[0],
						M = k[1],
						A = De((0, a.useState)(t.height), 2),
						C = A[0],
						x = A[1],
						N = De((0, a.useState)(t.heightUnit), 2),
						O = N[0],
						I = N[1],
						T = De((0, a.useState)(60), 2),
						j = T[0],
						V = T[1],
						R = De((0, a.useState)(60), 2),
						D = R[0],
						U = R[1],
						B = De((0, a.useState)([{
							key: "px",
					...
					function H() {
						p(window.innerHeight - 144 + 56), V(s.current.offsetHeight), U(c.current.offsetHeight)
					}
					...
					return (0, a.useEffect)((function() {
						...
						onChange: function() {
							var e = !h,
								...
								n = t[0],
								r = t[1];
							g(e), M(e ? "px" : _), I(e ? "px" : O), x(e ? parseInt(E * r / n, 10) : C), z(e ? [{
								key: "px",
								label: "px"
							}] : [{
								key: "px",
				...
				}, n(8833), n(815), n(9174), Be.propTypes = {
					triggerPopupClose: u().func
				}, n(5777);
				var Fe = n(3458);
				...
				function Qe(e) {
					var t = (0, a.useRef)(null),
						...
						d = c[0],
						m = c[1],
						p = qe((0, a.useState)($e()), 2),
						y = p[0],
						h = p[1],
						g = qe((0, a.useState)(function() {
							var e = function() {
						...
						v = qe((0, a.useState)(0), 2),
						b = v[0],
						S = v[1],
						w = qe((0, a.useState)(0), 2),
						E = w[0],
						P = w[1],
						k = qe((0, a.useState)(!1), 2),
						_ = k[0],
						M = k[1],
						A = qe((0, a.useState)(r), 2),
						C = A[0],
						x = A[1];
					...
					return (0, a.useEffect)((function() {
						...
						o.PageStore.on("window_resize", N), o.MediaPageStore.on("copied_media_link", O);
						...
						return S(i), P((a = (t = parseInt(i, 10)) - 3600 * (n = Math.floor(t / 3600)) - 60 * (r = Math.floor((t - 3600 * n) / 60)), n < 10 && (n = "0" + n), r < 10 && (r = "0" + r), a < 10 && (a = "0" + a), n >= 1 ? n + ":" + r + ":" + a : r + ":" + a)),
							function() {
								o.PageStore.removeListener("window_resize", N), o.MediaPageStore.removeListener("copied_media_link", O), u(null)
							}
					}), []), a.createElement("div", {
						ref: t,
						...
						onChange: function() {
							var e;
							M(!_), e = _ ? r : r + "&t=" + Math.trunc(b), x(e)
						}
					}), "Start at ", E)))
				}
				...
				function et(e) {
					var t, n = Ye((0, B.usePopup)(), 3),
						r = n[0],
						i = n[1],
						o = n[2],
						l = Ye((0, a.useState)("shareOptions"), 2),
						s = l[0],
						u = l[1];
					return a.createElement("div", {
						className: "share"
				...
				function it(e) {
					var t = nt((0, B.usePopup)(), 3),
						n = t[0],
						r = t[1],
						i = t[2],
						o = nt((0, a.useState)("main"), 2),
						l = o[0];
				...
				var mt = function(e) {
					...
					function u(e) {
						...
						}, t.downloadLink = "video" !== o.MediaPageStore.get("media-type") ? (0, m.formatInnerLink)(o.MediaPageStore.get("media-original-url"), i.SiteContext._currentValue.url) : null, t.updateStateValues = t.updateStateValues.bind(ct(t)), t
					}
					return t = u, (n = [{
						key: "componentDidMount",
						value: function() {
				...
				var bt = function(e) {
					...
					function u() {
						return pt(this, u), s.apply(this, arguments)
					}
					return t = u, (n = [{
						key: "render",
						value: function() {
				...
				var It = function(e) {
					...
					function s() {
						return At(this, s), l.apply(this, arguments)
					}
					return t = s, (n = [{
						key: "render",
						value: function() {
					...
					function s(e) {
						...
						return function(e, t) {
							...
							videoLoaded: !1
						}, t.onVideoLoad = t.onVideoLoad.bind(kt(t)), o.MediaPageStore.on("loaded_media_data", t.onVideoLoad), t
					}
					return t = s, (n = [{
						key: "onVideoLoad",
						value: function() {
				...
				var Ut = function(e) {
						...
						function s() {
							return jt(this, s), l.apply(this, arguments)
						}
						return t = s, (n = [{
							key: "render",
							value: function() {
				...
				function Ht(e) {
					var t = Ft((0, a.useState)(zt()), 2),
						n = t[0],
						r = t[1],
						i = Ft((0, a.useState)(o.PageStore.get("media-auto-play")), 2),
						l = i[0],
						s = i[1];
				...
				function Qt(e) {
					var t = Wt((0, a.useState)(c()), 2),
						n = t[0],
						r = t[1],
						i = Wt((0, a.useState)(null), 2),
						l = i[0],
						s = i[1];
				...
				var un = function(e) {
					...
					function s(e) {
						...
						return t.onMediaLoad = t.onMediaLoad.bind(ln(t)), t
					}
					return t = s, (n = [{
						key: "componentDidMount",
						value: function() {
				...
				var hn = function(e) {
					...
					function s(e) {
						...
						}, t.onWindowResize = t.onWindowResize.bind(pn(t)), t.onMediaLoad = t.onMediaLoad.bind(pn(t)), t.onMediaLoadError = t.onMediaLoadError.bind(pn(t)), t.onPagePlaylistLoad = t.onPagePlaylistLoad.bind(pn(t)), o.MediaPageStore.on("loaded_media_data", t.onMediaLoad), o.MediaPageStore.on("loaded_media_error", t.onMediaLoadError), o.MediaPageStore.on("loaded_page_playlist_data", t.onPagePlaylistLoad), t
					}
					return t = s, (n = [{
						key: "componentDidMount",
						value: function() {
				...
				if (window.MediaCMS.site.devEnv) {
					var Pn = function() {
						...
						kn = Pn.mediaId,
						_n = Pn.playlistId;
					kn && (window.MediaCMS.mediaId = kn), _n && (window.MediaCMS.playlistId = _n)
				}
				var Mn = function(e) {
					! function(e, t) {
						if ("function" != typeof t && null !== t) throw new TypeError("Super expression must either be null or a function");
					...
					function c() {
						return vn(this, c), u.apply(this, arguments)
					}
					return t = c, (n = [{
			...
			8727: function(e, t, n) {
				...
				function d(e) {
					...
					return a.playerVolume = null === a.playerVolume ? 1 : Math.max(Math.min(Number(a.playerVolume), 1), 0), a.playerSoundMuted = null !== a.playerSoundMuted && a.playerSoundMuted, a.videoQuality = null !== a.videoQuality ? a.videoQuality : "Auto", a.videoPlaybackSpeed = null !== a.videoPlaybackSpeed && a.videoPlaybackSpeed, a.inTheaterMode = null !== a.inTheaterMode && a.inTheaterMode, (0, r.useEffect)((function() {
						return e.inEmbed || document.hasFocus() || "visible" === document.visibilityState ? c() : (window.addEventListener("focus", c), document.addEventListener("visibilitychange", c)), n.player.one("loadedmetadata", (function() {
			...
			160: function(e, t, n) {
				...
				function h(e) {
					...
					var T, j = null,
						V = null,
						L = null,
						R = ((T = new(l())(e.pageLink).query) ? ((T = T.substring(1)).split("&"), T = T.length ? T.split("=") : []) : T = [], T);
					if (R.length)
						for (var D = 0; D < R.length;) "m" === R[D] && (L = R[D + 1]), D += 2;
					...
					function U(e) {
						if (void 0 !== e && e && void 0 !== e.data && e.data) {
							...
							var a = [],
								o = null,
								l = (0, d.RA)(V.encodings_info, V.hls_info),
								s = null,
								c = null;
							if ("string" == typeof V.poster_url ? o = (0, u.formatInnerLink)(V.poster_url, n.url) : "string" == typeof V.thumbnail_url && (o = (0, u.formatInnerLink)(V.thumbnail_url, n.url)), Object.keys(l).length) {
								var m = (0, d.KC)(),
									p = I.videoQuality;
								...
								for (r in V.encodings_info[y]) V.encodings_info[y].hasOwnProperty(r) && m.support[r] && (t = V.encodings_info[y][r].url) && (t = (0, u.formatInnerLink)(t, n.url), a.push({
									src: t,
							...
							i(s), h(c), b(o), E(a), _(l), C(V.subtitles_info), O(V.sprites_url ? {
								url: (0, u.formatInnerLink)(V.sprites_url, n.url),
								frame: {
									width: 160,
									height: 90,
									seconds: 10
					...
					return null !== L && (j = t.media + "/" + L), (0, r.useEffect)((function() {
						null !== j && (0, u.getRequest)(j, !1, U, B)
